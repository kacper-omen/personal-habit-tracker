...
const Hero = () => {
  return (
    <div className='flex flex-col text-center'>
        ...
        <Link to="/register" className='border-5 border-blue-800 rounded-2xl bg-blue-500 hover:bg-blue-600 transition text-slate-200 font-bold text-2xl px-2 py-5 my-5 mx-5 lg:w-2/3 lg:my-25 lg:py-10 lg:text-5xl mx-auto'>Get started for free</Link>
    </div>
