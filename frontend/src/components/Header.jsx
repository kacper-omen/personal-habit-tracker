  ...
  return (
    <div className='h-25 flex justify-between bg-gray-200 pl-5 border-b'>
        ...
        <div className='flex bg-gray-300'>
            ...
            <Link to="register">
              <div className='h-25 text-2xl md:text-3xl lg:text-4xl hover:bg-gray-400 border-x px-5 flex flex-col justify-center transition cursor-pointer'><p>Sign in</p></div>
            </Link>  
        </div> 
    </div>
  )
